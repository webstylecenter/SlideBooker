...
function create() {
    $('#test').html('<div class="resizable draggable blue"><h3>Beterhout - BHREM 192</h3><input type="text"' +
        ' value="Wijziging aangebracht die straks weer eruit mag"/><div class="startime">-</div>' +
        '<div class="tasktime">task</div><div class="endtime">-</div></div>');
